...
const CopyIcon = () => <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" /></svg>;
const EditIcon = () => <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.5L15.232 5.232z" /></svg>;
        ...
        <div className="flex flex-col md:flex-row h-screen bg-gray-100 font-sans">
            <div className="w-full md:w-1/3 bg-white p-8 shadow-lg overflow-y-auto flex flex-col h-screen">
                ...
                <div className="space-y-6 flex-grow">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 mb-2">Paste text directly or upload one or more files.</p>
                        <textarea
                            value={text}
                        ...
                        <input
                            ...
                            multiple
                        />
                        <button onClick={() => fileInputRef.current.click()} className="w-full flex items-center justify-center bg-blue-500 text-white font-bold py-3 px-4 rounded-lg hover:bg-blue-600 transition duration-300">
                    ...
                    <div>
                        <label htmlFor="prompt" className="text-lg font-semibold text-gray-700">2. Set Your Prompt</label>
            ...
            <div className="w-full md:w-2/3 p-8 flex flex-col h-screen">
                <div className="flex justify-between items-center mb-4">
                    ...
                    {copyStatus && <span className="text-green-600 font-semibold transition-opacity duration-300">{copyStatus}</span>}
                </div>
                <div className="relative flex-grow">
                    {isLoading ? (
                        ...
                        <textarea
                            ...
                            className={`w-full h-full p-4 pr-6 pb-16 text-lg leading-relaxed border rounded-lg resize-none hover:ring-2 hover:ring-blue-200
                                        ${isEditing ? 'bg-white ring-2 ring-blue-500' : 'bg-gray-50 border-gray-200'}
                    ...
                    {!isLoading && summary && (
                        <div className="absolute bottom-4 right-4 flex space-x-2">
                            ...
                            <button onClick={handleCopy} className="flex items-center bg-gray-200 text-gray-700 px-3 py-2 text-sm font-semibold rounded-md hover:bg-gray-300 transition">
                                <CopyIcon /> Copy
                            </button>
                            <button onClick={() => setIsShareModalOpen(true)} className="flex items-center bg-gray-200 text-gray-700 px-3 py-2 text-sm font-semibold rounded-md hover:bg-gray-300 transition">
                                <ShareIcon /> Share
                            </button>
                        </div>
                    )}
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white p-8 rounded-lg shadow-xl w-full max-w-md">
                        ...
                        <div className="flex justify-end space-x-3 mt-4">
                            <button onClick={() => setIsShareModalOpen(false)} className="px-4 py-2 bg-gray-200 rounded-lg hover:bg-gray-300">Cancel</button>
                            <button onClick={handleShare} className="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600">{shareStatus || 'Send'}</button>
                        </div>
                    </div>
                </div>
            )}
